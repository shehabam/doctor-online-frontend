...
class DoctorList extends Component {
  ...
  render() {
    ...
    let listOfDoctors = Store.doctorList.map(list => (
      <TouchableHighlight
        onPress={
          () => alert("kfjhvefljh")
          ...
          <Content>
            ...
            >
              {/* {to(filledStars).map((key) => (
								<Icon name="ios-star" style={{ color: 'yellow' }} {...{ key, size, color }} /> */}
              ))}
              {halfStar && (
                <Icon
                  name="ios-star-half"
              ...
              {/* {to(emptyStars).map((key) => (
								<Icon name="ios-star-outline" style={{ color: 'yellow' }} {...{ key, size, color }} />
							))} */}
              <Text style={styles.text}>{`${votes} votes`}</Text>
            </View>
            <CardItem style={styles.bookingButtonCardItem}>
              <Button full warning rounded style={styles.bookingButton}>
